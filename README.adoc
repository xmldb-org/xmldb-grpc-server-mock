...
:project-name: xmldb-grpc-server-mock
...
== Content
Contains a mock gRPC server side implementation in order to simulate a XML:DB API
access using the protobuf specified client/server communication.

This project should act as an example on how to implement a server side implementation.
